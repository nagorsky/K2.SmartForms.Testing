...
namespace ConsoleApplication2
{
    ...
    class Program
    {
        ...
        public static string runTestStep(ScenarioStep step, Settings settings)
        {
            ...
            else if (string.Equals(act, "WaitForElemPresentWithPageRefresh", StringComparison.CurrentCultureIgnoreCase))
            {
                ...
                var findElemCounter = findMyElements(step.attribute, step.attributeValue).Count;
                ...
                for (int i = 0; i < 20; i++)
                {
                    ...
                    findElemCounter = Convert.ToInt32(findMyElements(step.attribute, step.attributeValue).Count);
            ...
            else if (string.Equals(act, "AddToBuffer", StringComparison.CurrentCultureIgnoreCase))
            {
        ...
        public static DataSet loadDataSetFromExcelFile(string fileName)
        {
        ...
        public static List<ScenarioStep> loadScenarionSteps(string fileName, List<ScenarioStep> scenario, Settings settings)
        {
        ...
        static void Main(string[] args)
        {
            ...
            DataSet mainDS = loadDataSetFromExcelFile("Scenario.xlsx");
            ...
            scenario = loadScenarionSteps("Scenario.xlsx", scenario, settings);


            //profile.SetPreference("network.http.phishy-userpass-length", 255);
            //profile.SetPreference("network.automatic-ntlm-auth.trusted-uris", "k2farm");
